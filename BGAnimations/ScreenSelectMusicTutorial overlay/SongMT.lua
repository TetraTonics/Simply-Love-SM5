	...
	__index = {
		...
		set = function(self, song)
			...
			if type(song) == "string" then
				self.song = song
				self.title_bmt:settext( THEME:GetString("ScreenSelectMusicTutorial", "CloseThisFolder") )
				self.img_path = THEME:GetPathB("ScreenSelectMusicTutorial", "overlay/img/CloseThisFolder.png")
				...
				elseif song:HasBanner() then
					...
					if NoJacketTexture ~= nil then
						...
						self.banner:Load( THEME:GetPathB("ScreenSelectMusicTutorial", "overlay/img/no-jacket.png") )
